...
namespace Drupal\ol_text_docs\Plugin\Block;
...
class OlFilesHeaderBlock extends BlockBase {
  ...
  public function build() {
    ...
    $navigation_form = \Drupal::formBuilder()->getForm(\Drupal\ol_text_docs\Form\FilesNavigationForm::class, $id_group);
    ...
    $build = [
      '#theme' => 'ol_text_docs_header_block',
      '#cache' => ['max-age' => 0],
      '#vars' => $theme_vars,
    ];
    return $build;
